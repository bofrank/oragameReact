    ...
    fetch(recipeUrl)
      ...
      .then(edamamJSON => {
        ...
        if (ingredient == "salmon") {
          promoHTML = '<a itemscope itemtype="http://schema.org/Recipe" id="promo" class="item photo" href="https://www.jdoqocy.com/click-7903156-14026812" target="_blank"><div class="content"><img itemprop="image" id="imagePromo" class="grid-item-image" src="https://www.ftjcfx.com/image-7903156-14026812" onload="resizeAllGridItems()" /><div itemprop="name" id="titlePromo" class="grid-item-title">FREE Shipping</div><div class="grid-text"><div itemprop="recipeIngredient">Free Shipping On Wild Seafood & Organic Fare!</div></div></div></a>'
        } else {
          promoHTML =
