...
function getParams(t) {
    var e, i, n = {},
        i = t.split("?")[1];
    if (i)
        for (var e, s = i.split("#")[0].split("&"), a = 0; a < s.length; a++) e = s[a].split("="), n[e[0]] = decodeURIComponent(e[1]);
    return n
}

function getParamValue(t) {
    var e = getParams(window.location.href),
        i = null;
...
function track(t) {
    var e = t.hitType || t.type || "event",
        i = t.category || t.key,
        n = t.action || t.event || "Click",
        s = t.label || t.loc,
        a = t.value;
    blank(a) ? ga("send", e, i, n, s) : ga("send", e, i, n, s, a)
}! function(t, e) {
    ...
    function h(t, e, i, n) {
        if (se.acceptData(t)) {
            var s, a, o = se.expando,
                ...
                l = r ? se.cache : t,
                c = r ? t[o] : t[o] && o;
            if (c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof e) return c || (c = r ? t[o] = X.pop() || se.guid++ : o), l[c] || (l[c] = r ? {} : {
                toJSON: se.noop
            }), ("object" == typeof e || "function" == typeof e) && (n ? l[c] = se.extend(l[c], e) : l[c].data = se.extend(l[c].data, e)), a = l[c], n || (a.data || (a.data = {}), a = a.data), void 0 !== i && (a[se.camelCase(e)] = i), "string" == typeof e ? (s = a[e], null == s && (s = a[se.camelCase(e)])) : s = a, s
        }
    }
    ...
    function d(t, e, i) {
        if (se.acceptData(t)) {
            ...
            if (o[r]) {
                ...
                }(i || (delete o[r].data, c(o[r]))) && (a ? se.cleanData([t], !0) : ie.deleteExpando || o != o.window ? delete o[r] : o[r] = null)
            }
        }
    }
    ...
    function m(t, e) {
        var i, n, s = 0,
            a = typeof t.getElementsByTagName !== Ce ? t.getElementsByTagName(e || "*") : typeof t.querySelectorAll !== Ce ? t.querySelectorAll(e || "*") : void 0;
        if (!a)
    ...
    function R(t, e, i) {
        ...
        if (se.isEmptyObject(u)) "inline" === ("none" === c ? T(t.nodeName) : c) && (p.display = c);
        else {
    ...
    function H(t, e, i) {
        var n, s, a = 0,
            ...
            l = function() {
                if (s) return !1;
                for (var e = pi || F(), i = Math.max(0, c.startTime + c.duration - e), n = i / c.duration || 0, a = 1 - n, o = 0, l = c.tweens.length; l > o; o++) c.tweens[o].run(a);
            ...
            h = c.props;
        for (L(h, c.opts.specialEasing); o > a; a++)
            if (n = _i[a].call(c, t, h, c.opts)) return n;
        return se.map(h, N, c), se.isFunction(c.opts.start) && c.opts.start.call(t, c), se.fx.timer(se.extend(l, {
            elem: t,
            anim: c,
            queue: c.opts.queue
    ...
    function B(t, e, i, n) {
        ...
        for (a = h.shift(); a;)
            if (t.responseFields[a] && (i[t.responseFields[a]] = e), !l && n && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = a, a = h.shift())
                if ("*" === a) a = l;
                else if ("*" !== l && l !== a) {
            if (o = c[l + " " + a] || c["* " + a], !o)
                for (s in c)
                    if (r = s.split(" "), r[1] === a && (o = c[l + " " + r[0]] || c["* " + r[0]])) {
                        o === !0 ? o = c[s] : c[s] !== !0 && (a = r[0], h.unshift(r[1]));
                        break
                    }
            if (o !== !0)
                if (o && t["throws"]) e = o(e);
    ...
    se.fn = se.prototype = {
        ...
        for ("boolean" == typeof o && (c = o, o = arguments[r] || {}, r++), "object" == typeof o || se.isFunction(o) || (o = {}), r === l && (o = this, r--); l > r; r++)
            if (null != (s = arguments[r]))
                for (n in s) t = o[n], i = s[n], o !== i && (c && i && (se.isPlainObject(i) || (e = se.isArray(i))) ? (e ? (e = !1, a = t && se.isArray(t) ? t : []) : a = t && se.isPlainObject(t) ? t : {}, o[n] = se.extend(c, a, i)) : void 0 !== i && (o[n] = i));
        return o
    }, se.extend({
    ...
    var ce = function(t) {
        function e(t, e, i, n) {
            var s, a, o, r, l, c, d, p, f, g;
            if ((e ? e.ownerDocument || e : j) !== M && A(e), e = e || M, i = i || [], !t || "string" != typeof t) return i;
            ...
            if (z && !n) {
                if (s = _e.exec(t))
                    if (o = s[1]) {
                        ...
                        } else if (e.ownerDocument && (a = e.ownerDocument.getElementById(o)) && H(e, a) && a.id === o) return i.push(a), i
                    } else {
                ...
                if (w.qsa && (!N || !N.test(t))) {
                    if (p = d = O, f = e, g = 9 === r && t, 1 === r && "object" !== e.nodeName.toLowerCase()) {
                        for (c = T(t), (d = e.getAttribute("id")) ? p = d.replace(ye, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = c.length; l--;) c[l] = p + u(c[l]);
        ...
        function p(t, e, i) {
            ...
            return e.first ? function(e, i, a) {
                ...
                if (o) {
                    ...
                    for (; e = e[n];)
                        if (1 === e.nodeType || s) {
                            if (l = e[O] || (e[O] = {}), (r = l[n]) && r[0] === $ && r[1] === a) return c[2] = r[2];
        ...
        function v(t, e, i, s, a, o) {
            return s && !s[O] && (s = v(s)), a && !a[O] && (a = v(a, o)), n(function(n, o, r, l) {
                var c, h, d, u = [],
                    ...
                    _ = !t || !n && e ? v : m(v, u, t, r, l),
                    b = i ? a || (n ? t : f || s) ? [] : o : _;
                if (i && i(_, b, r, l), s)
                    for (c = m(b, p), s(c, [], r, l), h = c.length; h--;)(d = c[h]) && (b[p[h]] = !(_[p[h]] = d));
                if (n) {
                    if (a || t) {
                        if (a) {
                            for (c = [], h = b.length; h--;)(d = b[h]) && c.push(_[h] = d);
                            a(null, b = [], c, l)
                        }
                        for (h = b.length; h--;)(d = b[h]) && (c = a ? ee.call(n, d) : u[h]) > -1 && (n[c] = !(o[c] = d))
                    }
        ...
        function _(t) {
            for (var e, i, n, s = t.length, a = x.relative[t[0].type], o = a || x.relative[" "], r = a ? 1 : 0, l = p(function(t) {
                    ...
                    return !a && (n || i !== I) || ((e = i).nodeType ? l(t, i, n) : c(t, i, n))
                }]; s > r; r++)
                if (i = x.relative[t[r].type]) h = [p(f(h), i)];
                else {
                    if (i = x.filter[t[r].type].apply(null, t[r].matches), i[O]) {
                        for (n = ++r; s > n && !x.relative[t[n].type]; n++);
                        return v(r > 1 && f(h), r > 1 && u(t.slice(0, r - 1).concat({
                            value: " " === t[r - 2].type ? "*" : ""
                        })).replace(le, "$1"), i, n > r && _(t.slice(r, n)), s > n && _(t = t.slice(n)), s > n && u(t))
                    }
                    h.push(i)
                }
            return f(h)
            ...
            var s = i.length > 0,
                ...
                o = function(n, o, r, l, c) {
                    var h, d, u, p = 0,
                        ...
                        _ = I,
                        b = n || a && x.find.TAG("*", c),
                        y = $ += null == _ ? 1 : Math.random() || .1,
                        w = b.length;
                    for (c && (I = o !== M && o); f !== w && null != (h = b[f]); f++) {
                        if (a && h) {
                            for (d = 0; u = t[d++];)
                                if (u(h, o, r)) {
                                    l.push(h);
        ...
        var y, w, x, C, D, T, S, k, I, P, E, A, M, F, z, N, R, L, H, O = "sizzle" + -new Date,
            j = t.document,
            $ = 0,
            W = 0,
            B = i(),
        ...
        w = e.support = {}, D = e.isXML = function(t) {
            ...
            var e, i = t ? t.ownerDocument || t : j,
                n = i.defaultView;
            return i !== M && 9 === i.nodeType && i.documentElement ? (M = i, F = i.documentElement, z = !D(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function() {
                A()
            ...
            })), (w.matchesSelector = ve.test(L = F.matches || F.webkitMatchesSelector || F.mozMatchesSelector || F.oMatchesSelector || F.msMatchesSelector)) && s(function(t) {
                w.disconnectedMatch = L.call(t, "div"), L.call(t, "[s!='']:x"), R.push("!=", re)
            }), N = N.length && new RegExp(N.join("|")), R = R.length && new RegExp(R.join("|")), e = ve.test(F.compareDocumentPosition), H = e || ve.test(F.contains) ? function(t, e) {
                ...
                return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === j && H(j, t) ? -1 : e === i || e.ownerDocument === j && H(j, e) ? 1 : P ? ee.call(P, t) - ee.call(P, e) : 0 : 4 & n ? -1 : 1)
            } : function(t, e) {
                if (t === e) return E = !0, 0;
                var n, s = 0,
                    a = t.parentNode,
                ...
                for (; l[s] === c[s];) s++;
                return s ? o(l[s], c[s]) : l[s] === j ? -1 : c[s] === j ? 1 : 0
            }, i) : M
        }, e.matches = function(t, i) {
            return e(t, null, null, i)
        }, e.matchesSelector = function(t, i) {
            if ((t.ownerDocument || t) !== M && A(t), i = i.replace(de, "='$1']"), !(!w.matchesSelector || !z || R && R.test(i) || N && N.test(i))) try {
                var n = L.call(t, i);
            ...
            var e, i = [],
                n = 0,
                s = 0;
            if (E = !w.detectDuplicates, P = !w.sortStable && t.slice(0), t.sort(Y), E) {
            ...
            filter: {
                ...
                CHILD: function(t, e, i, n, s) {
                    ...
                    return 1 === n && 0 === s ? function(t) {
                        ...
                        var c, h, d, u, p, f, g = a !== o ? "nextSibling" : "previousSibling",
                            m = e.parentNode,
                        ...
                        if (m) {
                            ...
                            if (f = [o ? m.firstChild : m.lastChild], o && _) {
                                for (h = m[O] || (m[O] = {}), c = h[t] || [], p = c[0] === $ && c[1], u = c[0] === $ && c[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (u = p = 0) || f.pop();)
                                    if (1 === d.nodeType && ++u && d === e) {
                                        h[t] = [$, p, u];
                                        break
                                    }
                            } else if (_ && (c = (e[O] || (e[O] = {}))[t]) && c[0] === $) u = c[1];
                            else
                                for (;
                                    (d = ++p && d && d[g] || (u = p = 0) || f.pop()) && ((r ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++u || (_ && ((d[O] || (d[O] = {}))[t] = [$, u]), d !== e)););
        ...
        return d.prototype = x.filters = x.pseudos, x.setFilters = new d, T = e.tokenize = function(t, i) {
            var n, s, a, o, r, l, c, h = q[t + " "];
            if (h) return i ? 0 : h.slice(0);
            for (r = t, l = [], c = x.preFilter; r;) {
                (!n || (s = ce.exec(r))) && (s && (r = r.slice(s[0].length) || r), l.push(a = [])), n = !1, (s = he.exec(r)) && (n = s.shift(), a.push({
                    value: n,
                    type: s[0].replace(le, " ")
                }), r = r.slice(n.length));
            ...
            if (i = i || [], 1 === d.length) {
                ...
                for (s = fe.needsContext.test(t) ? 0 : a.length; s-- && (o = a[s], !x.relative[r = o.type]);)
                    if ((l = x.find[r]) && (n = l(o.matches[0].replace(we, xe), be.test(a[0].type) && h(e.parentNode) || e))) {
                        if (a.splice(s, 1), t = n.length && u(a), !t) return Z.apply(i, n), i;
                        break
                    }
            }
            return (c || S(t, d))(n, e, !z, i, be.test(t) && h(e.parentNode) || e), i
        }, w.sortStable = O.split("").sort(Y).join("") === O, w.detectDuplicates = !!E, A(), w.sortDetached = s(function(t) {
    ...
    var pe, fe = t.document,
        ...
        me = se.fn.init = function(t, e) {
            ...
            if ("string" == typeof t) {
                ...
                if (i[1]) {
                    if (e = e instanceof se ? e[0] : e, se.merge(this, se.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : fe, !0)), de.test(i[1]) && se.isPlainObject(e))
    ...
    se.extend({
        ...
        closest: function(t, e) {
            for (var i, n = 0, s = this.length, a = [], o = he.test(t) || "string" != typeof t ? se(t, e || this.context) : 0; s > n; n++)
    ...
    se.Callbacks = function(t) {
        ...
        when: function(t) {
            ...
            if (o > 1)
                for (e = new Array(o), i = new Array(o), n = new Array(o); o > s; s++) a[s] && se.isFunction(a[s].promise) ? a[s].promise().done(c(s, n, a)).fail(l.reject).progress(c(s, i, e)) : --r;
    ...
    var Se = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        Pe = se.access = function(t, e, i, n, s, a, o) {
            ...
            } else if (void 0 !== n && (s = !0, se.isFunction(n) || (o = !0), c && (o ? (e.call(t, n), e = null) : (c = e, e = function(t, e, i) {
    ...
    se.event = {
        ...
        add: function(t, e, i, n, s) {
            var a, o, r, l, c, h, d, u, p, f, g, m = se._data(t);
            if (m) {
                for (i.handler && (l = i, i = l.handler, s = l.selector), i.guid || (i.guid = se.guid++), (o = m.events) || (o = m.events = {}), (h = m.handle) || (h = m.handle = function(t) {
                        return typeof se === Ce || t && se.event.triggered === t.type ? void 0 : se.event.dispatch.apply(h.elem, arguments)
                    }, h.elem = t), e = (e || "").match(be) || [""], r = e.length; r--;) a = Ne.exec(e[r]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p && (c = se.event.special[p] || {}, p = (s ? c.delegateType : c.bindType) || p, c = se.event.special[p] || {}, d = se.extend({
                    type: p,
                    origType: g,
                    data: n,
                    handler: i,
                    ...
                    namespace: f.join(".")
                }, l), (u = o[p]) || (u = o[p] = [], u.delegateCount = 0, c.setup && c.setup.call(t, n, f, h) !== !1 || (t.addEventListener ? t.addEventListener(p, h, !1) : t.attachEvent && t.attachEvent("on" + p, h))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = i.guid)), s ? u.splice(u.delegateCount++, 0, d) : u.push(d), se.event.global[p] = !0);
                t = null
            }
        },
        remove: function(t, e, i, n, s) {
            var a, o, r, l, c, h, d, u, p, f, g, m = se.hasData(t) && se._data(t);
            if (m && (h = m.events)) {
                for (e = (e || "").match(be) || [""], c = e.length; c--;)
                    if (r = Ne.exec(e[c]) || [], p = g = r[1], f = (r[2] || "").split(".").sort(), p) {
                        for (d = se.event.special[p] || {}, p = (n ? d.delegateType : d.bindType) || p, u = h[p] || [], r = r[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = a = u.length; a--;) o = u[a], !s && g !== o.origType || i && i.guid !== o.guid || r && !r.test(o.namespace) || n && n !== o.selector && ("**" !== n || !o.selector) || (u.splice(a, 1), o.selector && u.delegateCount--, d.remove && d.remove.call(t, o));
                        l && !u.length && (d.teardown && d.teardown.call(t, f, m.handle) !== !1 || se.removeEvent(t, p, m.handle), delete h[p])
                    } else
                        for (p in h) se.event.remove(t, p + e[c], i, n, !0);
                se.isEmptyObject(h) && (delete m.handle, se._removeData(t, "events"))
            }
        },
        trigger: function(e, i, n, s) {
            var a, o, r, l, c, h, d, u = [n || fe],
                p = ee.call(e, "type") ? e.type : e,
                f = ee.call(e, "namespace") ? e.namespace.split(".") : [];
            if (r = h = n = n || fe, 3 !== n.nodeType && 8 !== n.nodeType && !ze.test(p + se.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), o = p.indexOf(":") < 0 && "on" + p, e = e[se.expando] ? e : new se.Event(p, "object" == typeof e && e), e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : se.makeArray(i, [e]), c = se.event.special[p] || {}, s || !c.trigger || c.trigger.apply(n, i) !== !1)) {
                if (!s && !c.noBubble && !se.isWindow(n)) {
                    for (l = c.delegateType || p, ze.test(l + p) || (r = r.parentNode); r; r = r.parentNode) u.push(r), h = r;
                    h === (n.ownerDocument || fe) && u.push(h.defaultView || h.parentWindow || t)
                }
                for (d = 0;
                    (r = u[d++]) && !e.isPropagationStopped();) e.type = d > 1 ? l : c.bindType || p, a = (se._data(r, "events") || {})[e.type] && se._data(r, "handle"), a && a.apply(r, i), a = o && r[o], a && a.apply && se.acceptData(r) && (e.result = a.apply(r, i), e.result === !1 && e.preventDefault());
                if (e.type = p, !s && !e.isDefaultPrevented() && (!c._default || c._default.apply(u.pop(), i) === !1) && se.acceptData(n) && o && n[p] && !se.isWindow(n)) {
                    h = n[o], h && (n[o] = null), se.event.triggered = p;
                    try {
                        n[p]()
                    } catch (g) {}
                    se.event.triggered = void 0, h && (n[o] = h)
                }
                return e.result
            }
        },
        ...
        fix: function(t) {
            ...
            var e, i, n, s = t.type,
                a = t,
                o = this.fixHooks[s];
            for (o || (this.fixHooks[s] = o = Fe.test(s) ? this.mouseHooks : Me.test(s) ? this.keyHooks : {}), n = o.props ? this.props.concat(o.props) : this.props, t = new se.Event(a), e = n.length; e--;) i = n[e], t[i] = a[i];
    ...
    var Re = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        Qe = g(fe),
        Ge = Qe.appendChild(fe.createElement("div"));
    Ke.optgroup = Ke.option, Ke.tbody = Ke.tfoot = Ke.colgroup = Ke.caption = Ke.thead, Ke.th = Ke.td, se.extend({
        clone: function(t, e, i) {
            ...
            if (ie.html5Clone || se.isXMLDoc(t) || !He.test("<" + t.nodeName + ">") ? a = t.cloneNode(!0) : (Ge.innerHTML = t.outerHTML, Ge.removeChild(a = Ge.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || se.isXMLDoc(t)))
                for (n = m(a), r = m(t), o = 0; null != (s = r[o]); ++o) n[o] && C(s, n[o]);
            if (e)
                if (i)
        ...
        buildFragment: function(t, e, i, n) {
            for (var s, a, o, r, l, c, h, d = t.length, u = g(e), p = [], f = 0; d > f; f++)
                if (a = t[f], a || 0 === a)
                    if ("object" === se.type(a)) se.merge(p, a.nodeType ? [a] : a);
                    else if (Be.test(a)) {
                for (r = r || u.appendChild(e.createElement("div")), l = ($e.exec(a) || ["", ""])[1].toLowerCase(), h = Ke[l] || Ke._default, r.innerHTML = h[1] + a.replace(je, "<$1></$2>") + h[2], s = h[0]; s--;) r = r.lastChild;
                if (!ie.leadingWhitespace && Oe.test(a) && p.push(e.createTextNode(Oe.exec(a)[0])), !ie.tbody)
                    for (a = "table" !== l || We.test(a) ? "<table>" !== h[1] || We.test(a) ? 0 : r : r.firstChild, s = a && a.childNodes.length; s--;) se.nodeName(c = a.childNodes[s], "tbody") && !c.childNodes.length && a.removeChild(c);
                for (se.merge(p, r.childNodes), r.textContent = ""; r.firstChild;) r.removeChild(r.firstChild);
                r = u.lastChild
            } else p.push(e.createTextNode(a));
            for (r && u.removeChild(r), ie.appendChecked || se.grep(m(p, "input"), v), f = 0; a = p[f++];)
                if ((!n || -1 === se.inArray(a, n)) && (o = se.contains(a.ownerDocument, a), r = m(u.appendChild(a), "script"), o && w(r), i))
                    for (s = 0; a = r[s++];) Ye.test(a.type || "") && i.push(a);
            return r = null, u
        },
        cleanData: function(t, e) {
            for (var i, n, s, a, o = 0, r = se.expando, l = se.cache, c = ie.deleteExpando, h = se.event.special; null != (i = t[o]); o++)
                if ((e || se.acceptData(i)) && (s = i[r], a = s && l[s])) {
                    if (a.events)
                        for (n in a.events) h[n] ? se.event.remove(i, n) : se.removeEvent(i, n, a.handle);
        ...
        html: function(t) {
            return Pe(this, function(t) {
                ...
                if (!("string" != typeof t || qe.test(t) || !ie.htmlSerialize && He.test(t) || !ie.leadingWhitespace && Oe.test(t) || Ke[($e.exec(t) || ["", ""])[1].toLowerCase()])) {
                    t = t.replace(je, "<$1></$2>");
                    try {
        ...
        domManip: function(t, e) {
            ...
            var i, n, s, a, o, r, l = 0,
                ...
                u = t[0],
                p = se.isFunction(u);
            if (p || c > 1 && "string" == typeof u && !ie.checkClone && Ue.test(u)) return this.each(function(i) {
                var n = h.eq(i);
            ...
            if (c && (r = se.buildFragment(t, this[0].ownerDocument, !1, this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
                for (a = se.map(m(r, "script"), b), s = a.length; c > l; l++) n = r, l !== d && (n = se.clone(n, !0, !0), s && se.merge(a, m(n, "script"))), e.call(this[l], n, l);
                if (s)
                    for (o = a[a.length - 1].ownerDocument, se.map(a, y), l = 0; s > l; l++) n = a[l], Ye.test(n.type || "") && !se._data(n, "globalEval") && se.contains(o, n) && (n.src ? se._evalUrl && se._evalUrl(n.src) : se.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Xe, "")));
                r = i = null
            }
            return this
        }
    ...
    se.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                if (a = typeof i, "string" === a && (s = ci.exec(i)) && (i = (s[1] + 1) * s[2] + parseFloat(se.css(t, e)), a = "number"), null != i && i === i && ("number" !== a || se.cssNumber[r] || (i += "px"), ie.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(o && "set" in o && void 0 === (i = o.set(t, i, n))))) try {
                    l[e] = i
                } catch (c) {}
            }
        },
        ...
        se.cssHooks[e] = {
            get: function(t, i, n) {
                return i ? ri.test(se.css(t, "display")) && 0 === t.offsetWidth ? se.swap(t, hi, function() {
                    return A(t, e, n)
                }) : A(t, e, n) : void 0
            },
            set: function(t, i, n) {
    ...
    se.fn.extend({
        ...
        removeAttr: function(t, e) {
            var i, n, s = 0,
                a = e && e.match(be);
            if (a && 1 === t.nodeType)
                for (; i = a[s++];) n = se.propFix[i] || i, se.expr.match.bool.test(i) ? Si && Ti || !Di.test(i) ? t[n] = !1 : t[se.camelCase("default-" + i)] = t[n] = !1 : se.attr(t, i, ""), t.removeAttribute(Ti ? i : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    var ki = /^(?:input|select|textarea|button|object)$/i,
        Ii = /^(?:a|area)$/i;
    se.fn.extend({
        prop: function(t, e) {
        ...
        addClass: function(t) {
            ...
            if (c)
                for (e = (t || "").match(be) || []; l > r; r++)
                    if (i = this[r], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(Pi, " ") : " ")) {
    ...
    se.parseJSON = function(e) {
        ...
        var i, n = null,
            s = se.trim(e + "");
        return s && !se.trim(s.replace(Mi, function(t, e, s, a) {
    ...
    Fi = $i.exec(zi.toLowerCase()) || [], se.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(t, e) {
            function i(t, e, i, n) {
                var s, h, v, _, y, x = e;
                2 !== b && (b = 2, r && clearTimeout(r), c = void 0, o = n || "", w.readyState = t > 0 ? 4 : 0, s = t >= 200 && 300 > t || 304 === t, i && (_ = W(d, w, i)), _ = B(d, _, w, s), s ? (d.ifModified && (y = w.getResponseHeader("Last-Modified"), y && (se.lastModified[a] = y), y = w.getResponseHeader("etag"), y && (se.etag[a] = y)), 204 === t || "HEAD" === d.type ? x = "nocontent" : 304 === t ? x = "notmodified" : (x = _.state, h = _.data, v = _.error, s = !v)) : (v = x, (t || !x) && (x = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || x) + "", s ? f.resolveWith(u, [h, x, w]) : f.rejectWith(u, [w, x, v]), w.statusCode(m), m = void 0, l && p.trigger(s ? "ajaxSuccess" : "ajaxError", [w, d, s ? h : v]), g.fireWith(u, [w, x]), l && (p.trigger("ajaxComplete", [w, d]), --se.active || se.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (e = t, t = void 0), e = e || {};
            var n, s, a, o, r, l, c, h, d = se.ajaxSetup({}, e),
                u = d.context || d,
                p = d.context && (u.nodeType || u.jquery) ? se(u) : se.event,
                f = se.Deferred(),
                ...
                w = {
                    ...
                    getResponseHeader: function(t) {
                        ...
                        if (2 === b) {
                            if (!h)
                                for (h = {}; e = Li.exec(o);) h[e[1].toLowerCase()] = e[2];
                            e = h[t.toLowerCase()]
                        }
            ...
            if (f.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || zi) + "").replace(Ni, "").replace(ji, Fi[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = se.trim(d.dataType || "*").toLowerCase().match(be) || [""], null == d.crossDomain && (n = $i.exec(d.url.toLowerCase()), d.crossDomain = !(!n || n[1] === Fi[1] && n[2] === Fi[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Fi[3] || ("http:" === Fi[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = se.param(d.data, d.traditional)), j(Wi, d, e, w), 2 === b) return w;
            l = d.global, l && 0 === se.active++ && se.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Oi.test(d.type), a = d.url, d.hasContent || (d.data && (a = d.url += (Ai.test(a) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = Ri.test(a) ? a.replace(Ri, "$1_=" + Ei++) : a + (Ai.test(a) ? "&" : "?") + "_=" + Ei++)), d.ifModified && (se.lastModified[a] && w.setRequestHeader("If-Modified-Since", se.lastModified[a]), se.etag[a] && w.setRequestHeader("If-None-Match", se.etag[a])), (d.data && d.hasContent && d.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + qi + "; q=0.01" : "") : d.accepts["*"]);
    ...
    se.offset = {
        setOffset: function(t, e, i) {
            var n, s, a, o, r, l, c, h = se.css(t, "position"),
                d = se(t),
                u = {};
            "static" === h && (t.style.position = "relative"), r = d.offset(), a = se.css(t, "top"), l = se.css(t, "left"), c = ("absolute" === h || "fixed" === h) && se.inArray("auto", [a, l]) > -1, c ? (n = d.position(), o = n.top, s = n.left) : (o = parseFloat(a) || 0, s = parseFloat(l) || 0), se.isFunction(e) && (e = e.call(t, i, r)), null != e.top && (u.top = e.top - r.top + o), null != e.left && (u.left = e.left - r.left + s), "using" in e ? e.using.call(t, u) : d.css(u)
        }
    }, se.fn.extend({
        offset: function(t) {
...
function(t, e, i) {
    ...
    var r, l, c = "[object OperaMini]" == Object.prototype.toString.call(t.operamini),
        h = "placeholder" in e.createElement("input") && !c,
        d = "placeholder" in e.createElement("textarea") && !c,
        u = i.fn,
        p = i.valHooks,
        f = i.propHooks;
    h && d ? (l = u.placeholder = function() {
        return this
    }, l.input = l.textarea = !0) : (l = u.placeholder = function() {
        var t = this;
        return t.filter((h ? "textarea" : ":input") + "[placeholder]").not(".placeholder").bind({
            "focus.placeholder": s,
            "blur.placeholder": a
        }).data("placeholder-enabled", !0).trigger("blur.placeholder"), t
    }, l.input = h, l.textarea = d, r = {
        get: function(t) {
            var e = i(t),
    ...
    }, h || (p.input = r, f.value = r), d || (p.textarea = r, f.value = r), i(function() {
...
function(t, e, i) {
    ...
    var a = /\+/g,
        o = t.cookie = function(a, r, l) {
            ...
            for (var d, u = o.raw ? n : s, p = e.cookie.split("; "), f = 0; d = p[f] && p[f].split("="); f++)
                if (u(d.shift()) === a) {
                    var g = u(d.join("="));
...
function(t, e) {
    ...
    l.prototype.getMeasurements = function() {
        ...
        function i(t) {
            return o.concat(["font-weight:" + m.weight, "font-style:" + m.style]).concat("font-family:" + t).join(";")
        }
        ...
        function l() {
            return (new Date).getTime() - h.getTime() > m.timeout
        }
        var c, h = new Date,
            d = this,
            u = d.serif,
            ...
            _ = r.replace(/\%s/, i(n)),
            b = r.replace(/\%s/, i(s));
        f || (f = d.parent = e.createElement("div")), f.innerHTML = _ + b, p = d.sansSerif = f.firstChild, u = d.serif = p.nextSibling, m.glyphs && (p.innerHTML += m.glyphs, u.innerHTML += m.glyphs),
            function y() {
                v || (v = e.body), !g && v && (v.appendChild(f), g = d.appended = !0, c = d.getMeasurements(), p.style.fontFamily = d.fontFamily + ", " + n, u.style.fontFamily = d.fontFamily + ", " + s), g && c && (a(c.sansSerif, p, m.tolerance) || a(c.serif, u, m.tolerance)) ? m.success() : l() ? m.error() : !g && "requestAnimationFrame" in window ? t.requestAnimationFrame(y) : t.setTimeout(y, m.delay)
            }()
    }, l.prototype.cleanFamilyName = function(t) {
        return t.replace(/[\'\"]/g, "").toLowerCase()
    }, l.prototype.cleanWeight = function(t) {
        var e = {
            normal: "400",
            bold: "700"
        };
        ...
        var s;
        for (var o in a) n.hasOwnProperty(o) || (n[o] = a[o]);
        this.options = n, this.fontFamily = i, !n.glyphs && "fonts" in e ? (n.timeout && (s = t.setTimeout(function() {
            n.error()
        }, n.timeout)), this.checkFontFaces(s)) : this.load()
    };
    var c = function(t, e) {
        var i = new l;
        return i.init(t, e), i
    ...
    t.fn.dropdown = function(e) {
        ...
        var t = $(this).findDropdown();
        if (!t) return void 0;
        var e = t.children('input[type="hidden"]').val();
        ...
        return this.each(function() {
            ...
            return i.length > 0 ? (i.val(t), e.hasClass("ready") && (i.change(), i.get(0).form && $.fn.valid && i.valid())) : (e.data("value", t), e.hasClass("ready") && e.change()), this
        })
    }, $.fn.resetDropdown = function(t) {
        return this.each(function() {
            var e = $(this).findDropdown();
            if (!e) return this;
            var i = e.data("init-value");
            if ("undefined" == typeof i || "unselect" == t) {
                e.removeClass("selected").find(".dropdown-menu a").removeClass("active"), e.children('input[type="hidden"]').removeAttr("value").change(), e.parents(".form-group").removeClass("has-error");
                var i = e.data("value");
                "undefined" != typeof i && e.removeData("value").change()
            } else e.changeDropdownByValue(i);
            return this
        })
    }, $.fn.refreshDropdown = function() {
        return this.each(function() {
            var t = $(this).findDropdown();
            return t ? (t.removeClass("ready").initializeDropdown(), void 0) : this
        })
        ...
        return this.each(function() {
            ...
            var e = $(document).width(),
                i = t.children(".dropdown-menu");
            if (i.css("max-width", e - 20 - (i.width() - i.children("li:first").width())), i.hasClass("dropdown-menu-left") || i.hasClass("dropdown-menu-right")) i.css("margin-right", "");
            else {
                var n = i.outerWidth(),
                    s = t.children("button"),
                    a = s.offset().left,
                    o = Math.ceil((n - s.outerWidth()) / 2),
                    r = -Math.floor(n / 2);
                if (o > a) r = r - o + a - 6;
                else {
            ...
            var c = t.children(".dropdown-menu-pointer");
            return c.length < 1 && (c = $("<div></div>").addClass("dropdown-menu-pointer").insertAfter(t.children(".dropdown-menu"))), c.css("left", Math.floor((t.outerWidth() - c.outerWidth()) / 2) + "px"), this
        })
    ...
    function(t, e) {
        ...
        function i(e, i) {
            this.element = e, this.$el = t(e), this.options = t.extend({}, s, i), this._defaults = s, this.init()
        }
        var n = "loader",
            s = {
                dimmer: ".dimmer",
        ...
        i.prototype = {
            init: function() {
                this._bindUIElements(), this.isFrozen = !1
            },
            _bindUIElements: function() {
                this.ui = {
                    links: this.$el.find("a"),
                    formTextInputs: this.$el.find('input[type="text"]:not([readonly]), textarea:not([readonly])'),
                    formControlsToDisable: this.$el.find("select, button, input:submit, input:reset, input:checkbox, input:radio"),
                    formLabels: this.$el.find("label:not(.disabled)"),
                    parentModal: this.$el.parents(".modal"),
                    sliders: null
                }, this.$el.find("input.slider").length && (this.ui.sliders = this.$el.find("input.slider").filter(function(e, i) {
                    return t(i).data("slider") && t(i).slider("isEnabled")
                }))
            },
            _renderDimmer: function() {
                if (this.$el.addClass("freeze"), !this.$el.find(this.options.dimmer).length) {
                    var e = t('<div class="' + this.options.dimmer.replace(".", "") + '"></div>');
                    this.$el.append(e)
                }
            },
            _removeDimmer: function() {
                this.$el.find(this.options.dimmer).remove()
            },
            freeze: function() {
                this.isFrozen ? setTimeout(t.proxy(function() {
                    this.$el.trigger("frozen")
                }, this), 1) : (this._renderDimmer(), this.isFrozen = !0, this.toggleComponents(!1), setTimeout(t.proxy(function() {
                    this.$el.addClass(this.options.animateClass), setTimeout(t.proxy(function() {
                        this.$el.trigger("frozen")
                    }, this), 1)
                }, this), 1), this.options.warnBeforeUnload && t(e).on("beforeunload.freeze", t.proxy(function() {
                    return this.options.beforeUnloadMessage
                }, this)))
            },
            unfreeze: function() {
                function i() {
                    this._removeDimmer(), this.$el.removeClass("freeze"), this.options.warnBeforeUnload && t(e).off("beforeunload.freeze"), this.$el.trigger("unfrozen")
                }
                this.isFrozen ? (this.isFrozen = !1, this.toggleComponents(!0), this.$el.removeClass(this.options.animateClass), t.support.transition && this.$el.hasClass("freeze") ? this.$el.find(this.options.dimmer).one("webkitTransitionEnd transitionend oTransitionEnd otransitionend", t.proxy(i, this)).emulateTransitionEnd(this.options.animateDuration + 50) : i.call(this)) : this.$el.trigger("unfrozen")
            },
            toggleComponents: function(e) {
                if (this.ui.formTextInputs.prop("readonly", !e), this.ui.formLabels[e ? "removeClass" : "addClass"]("disabled"), e ? this.ui.formControlsToDisable.off("click.freeze keypress.freeze") : this.ui.formControlsToDisable.on("click.freeze keypress.freeze", function(t) {
                        t.preventDefault()
                    }), e ? this.ui.links.each(function() {
                        var e = t(this),
                            i = e.data("initial-tabindex");
                        void 0 !== i ? e.attr("tabindex", i) : e.removeAttr("tabindex")
                    }) : this.ui.links.each(function() {
                        var e = t(this);
                        if (e.is("[tabindex]")) {
                            var i = e.attr("tabindex");
                            e.data("initial-tabindex", i)
                        }
                        e.attr("tabindex", -1)
                    }), this.ui.parentModal.length && (e ? this.ui.parentModal.off("hide.bs.modal.freeze") : this.ui.parentModal.on("hide.bs.modal.freeze", function() {
                        return !1
                    })), this.ui.sliders && this.ui.sliders.length) {
                    var i = e ? "enable" : "disable";
                    this.ui.sliders.each(function(e, n) {
                        t(n).data("slider") && t(n).slider(i)
                    })
                }
            }
        }, t.fn.extend({
            freeze: function(e) {
                return this.each(function() {
                    ...
                    s || (s = new i(this, e), t.data(this, "plugin_" + n, s)), s.freeze()
                })
            },
            unfreeze: function(e) {
                return this.each(function() {
                    var s = t.data(this, "plugin_" + n);
                    s || (s = new i(this, e), t.data(this, "plugin_" + n, s)), s.unfreeze()
                })
            }
        })
    }(jQuery, window, document, void 0), String.prototype.supplant || (String.prototype.supplant = function(t) {
        ...
        $body.on("click", ".tclick", function() {
            var t = $(this).data("track-category") || $(this).data("tkey"),
                e = $(this).data("track-action") || $(this).data("action") || "Click",
                i = $(this).data("track-label") || $(this).data("tloc");
            blank(t) || blank(i) || track({
                hitType: "event",
                category: t,
                action: e,
                label: i
        ...
        $("header .logo"), $("#language"), $("header .account .dropdown-toggle"), $("#language input").change(function() {
            track({
                ...
                loc: "Change Language",
                evt: "Select"
            }), $body.freeze(), postAndReload("/users/set_language/", "lang", $(this).val())
        }), $("#currency input").change(function() {
            track({
                key: "Top Nav",
                loc: "Change Currency",
                evt: "Select"
            }), $body.freeze(), postAndReload("/users/set_currency/", "currency", $(this).val())
        });
        var i = $("#birdhouse");
        if (i.length > 0) {
            var n = $("#birdhouse-popup"),
                s = null;
            $body.hasClass("touch") || i.hover(t, e), i.click(function() {
        ...
        $("#mobile-app-banner .open").click(function() {
            location.href = $(this).attr("data-href") + "?link=" + encodeURIComponent(location.href) + "&ibi=com.travelmob.main&isi=762029067"
        }), blank(gon.user_migrated_at) || $(".list-space").bind("click", function(t) {
            t.preventDefault()
        })
    }), $(function() {
        function t() {
            e.hasClass("open") && (e.removeClass("open"), s.animate({
                opacity: 0
            }, 300, function() {
                $(this).hide()
            }), $body.removeClass("modal-open"), o && (r && (a.attr("content", l), r = !1), $(document).scrollTop() > 100 && $(document).scrollTop(0)))
        }
        var e = $("#menu"),
            i = e.children(".account");
        e.find("li:not(.help) a");
        var n = e.find(".search"),
            s = $("#menu-overlay"),
            a = $('meta[name="viewport"]'),
            o = a.attr("content").indexOf("user-scalable=no") < 0 && isIOS;
        if (o) var r, l = a.attr("content");
        $("#menu-toggle").click(function() {
            return e.addClass("open opening"), s.show().animate({
                opacity: .6
            }, 300, function() {
                e.removeClass("opening")
            }), $body.addClass("modal-open"), o && window.innerWidth >= screen.width && (a.attr("content", "width=device-width, user-scalable=no"), r = !0), !1
        }).one("click", function() {
            function t(t) {
                var e = $("#" + t + " .dropdown"),
                    i = e.children('input[type="hidden"]').val(),
                    n = $("<select></select>").attr("class", t + " form-control");
                return e.find(".dropdown-menu li").each(function() {
                    var t = $(this).children(),
                        e = t.data("value"),
                        s = $("<option></option>").text(t.text()).val(e);
            ...
            t("currency").change(function() {
                track({
                    ...
                    loc: "Change Currency",
                    evt: "Select"
                }), postAndReload("/users/set_currency/", "currency", $(this).val())
            }).prependTo("#menu-bottom"), t("language").change(function() {
                track({
                    key: "Side Menu",
                    loc: "Change Language",
                    evt: "Select"
                }), postAndReload("/users/set_language/", "lang", $(this).val())
            }).prependTo("#menu-bottom")
        }), s.click(t), isTouchDevice && (e.on("touchmove", function(t) {
            e[0].scrollHeight <= e.height() && t.preventDefault()
        }), s.on("touchmove", function(t) {
            t.preventDefault()
        })), $(window).on("widthchange", function() {
            e.hasClass("open") && !n.is(":visible") && (e.hasClass("opening") ? setTimeout(t, 300) : t())
            ...
            var e = $("#search-modal");
            if (e.length < 1 && ($("#body").append('<div id="search-modal" class="modal fade hide" tabindex="-1" role="dialog" aria-labelledby="search-modal-title"></div>'), e = $("#search-modal")), e.children().length < 1) {
                var i = "";
                ("object" != typeof google || "object" != typeof google.maps || "object" != typeof google.maps.places) && (i += "?autocomplete_j"), $(".pac-container").css("border") || (i += "" == i ? "?autocomplete_c" : "&autocomplete_c"), "undefined" == typeof DatePanel && (i += "" == i ? "?dates" : "&dates"), "undefined" == typeof e.shake && (i += "" == i ? "?shake" : "&shake"), e.load("/search/modal" + i, function(t, i) {
                    "error" == i && e.modal("hide")
                })
            }
            return t(), e.modal(), !1
        })
...
var $window = $(window),
    $body = $(document.body),
    isIOS = /iP(ad|hone|od)/.test(navigator.userAgent) && !window.MSStream,
    isSigninOrSignup = "/login" == window.location.pathname || "/signup" == window.location.pathname,
    isSvgSupported = document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"),
    isTouchDevice = "ontouchstart" in document.documentElement,
    windowWidth, windowHeight, previousWindowWidth, previousWindowHeight;
sessionStorage.fontLoaded ? $body.addClass("font-load") : FontFaceOnload("BerninoSansWeb", {
    success: function() {
        $body.addClass("font-load");
        try {
            sessionStorage.fontLoaded = !0
        } catch (t) {}
    },
    error: function() {
        $body.addClass("font-none")
    }
}), isIOS && $body.addClass("ios"), isTouchDevice && $body.addClass("touch"), $(function() {
    $("input, textarea").placeholder(), windowWidth = previousWindowWidth = $window.width(), windowHeight = previousWindowHeight = isIOS ? window.innerHeight : $window.height(), $window.resize(function() {
        previousWindowWidth = windowWidth, previousWindowHeight = windowHeight, windowWidth = $window.width(), windowHeight = isIOS ? window.innerHeight : $window.height();
        var t = windowWidth != previousWindowWidth,
            e = windowHeight != previousWindowHeight;
